...
class ExtractSubprocessor(Subprocessor):
    ...
    class Cli(Subprocessor.Cli):
        ...
        def process_data(self, data):
            ...
            #print("inside process_data",self.type, h, w, c)
        ...
        def landmarks_stage(data,
            ...
            #print(np.array(data.landmarks).shape)
            return data
        ...
        def final_stage(data,
            ...
            for rect, image_landmarks in zip( rects, landmarks ):
                ...
                if face_type == FaceType.MARK_ONLY:
                    ...
                    # print("before affine image size", image.shape, image_size, image_size)
                ...
                json_path = output_path / f"{filepath.stem}_{face_idx}.json"
